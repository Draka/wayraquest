    ...
    var Game = Class.extend({
        init: function(app) {
            ...
            this.spriteNames = ["hand", "sword", "loot", "target", "talk", "sparks", "shadow16", "rat", "skeleton", "skeleton2", "spectre", "boss", "deathknight", 
                                "ogre", "crab", "snake", "eye", "bat", "goblin", "wizard", "guard", "draka", "villagegirl", "villager", "coder", "agent", "rick", "scientist", "nyan", "priest", 
        ...
        initAchievements: function() {
            ...
            this.achievements = {
                SMALL_TALK: {
                    id: 4,
                    name: "Una charla",
                    desc: "Empezar una charla con un jugador del sistema",
                    hidden: true
                },
                GIRL_TALK: {
                    id: 2,
                    name: "Hay una mujer!!!",
                    desc: "Hablar con la única mujer NPC",
                    hidden: true
                },
                ROOM: {
                    id: 5,
                    name: "Sala inicial",
                    desc: "Entrar a la sala de proyectos",
                    hidden: true
                },
                ...
                TOP: {
                    id: 1,
                    name: "Lo más arriba",
                    desc: "Llegar a lo más arriba posible",
                    hidden: true
                },
                ...
                STILL_ALIVE: {
                    id: 6,
                    name: "Entrar a Wayra",
                    desc: "Cargar una nueva sesión y entrar a Wayra.",
                    hidden: true
                }
            };
        ...
        connect: function(started_callback) {
            ...
            this.client.onWelcome(function(id, name, x, y, hp) {
                ...
                if(!self.storage.hasAlreadyPlayed()) {
                    ...
                    self.showNotification("Bienvenido a Wayra");
                } else {
                    self.showNotification("Bienvenido de nuevo a Wayra");
                ...
                self.player.onStep(function() {
                    ...
                    if(self.player.gridX >= 41 && self.player.gridY >= 65 && self.player.gridY < 75) {
                        self.tryUnlockingAchievement("ROOM");
                    }
                    if(self.player.gridX >= 53 && self.player.gridY <= 28) {
                        self.tryUnlockingAchievement("TOP");
                    }
        ...
        makeNpcTalk: function(npc) {
            ...
            if(npc) {
                ...
                if(npc.kind === Types.Entities.VILLAGEGIRL) {
                    this.tryUnlockingAchievement("GIRL_TALK");
                }
            }
        },
